<?php
    ...
    //     echo $date;
    //     foreach($post as $key => $post_content){
    //         echo var_dump($key, $post_content);
    //     }
    // }
...
<body>
    ...
    <?php foreach($posts as $date => $post){ ?>
        <h2><?= $date?></h2>
        <ul>    
        <?php foreach($post as $post_content){ ?>
            <li><?php echo $post_content['title']?></li>
            <p><?php echo $post_content['author']?></p>
            <p><?php echo $post_content['text']?></p>
        <?php } ?>
        </ul>
    <?php } ?>
</body>
